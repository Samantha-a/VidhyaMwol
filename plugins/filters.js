...
const array = ['Hi','Hii','Hi nanba','power','sad','anthas','failed','alla','chunk','marichu','Antha parupadi','HELLO','Mass','myre','think','cheyalle','mention','set','eda','police','aysheri','vannu','love','Allavarum avida','Antha parupadi','Smile','🔥🔥','😁','Gd mrng','manasilla','uyir','oombi','Mm','important','sed','chathu','girl','poweresh','ooo','bye','fuck','pedicho','kunna','number','ok','pwoli','chiri','vibe','shut','saved','Good morning all','Good night','Da','mood','shaad','pidi','Njan athe','Love','Vanakam','Jd','Kannan','Albin','Helo','Aarulle','Oiii','Babe','Umma']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
